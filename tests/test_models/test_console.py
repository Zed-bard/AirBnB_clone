#!/usr/bin/python3
"""Establishes unit tests for console.py.
...
class TestHBNBCommandcreate(unittest.TestCase):
    ...
    def test_create_object(self):
        """
    Test the creation of objects using the `create` command in the HBNBCommand class.

    For each specified model, it checks if the creation was successful by verifying if the
    corresponding key exists in the storage after executing the command.
